import { InMemoryQuestionsRepository } from '../../../../../src/modules/tournaments-registrations/infrastructure/repository/inmemory/InMemoryQuestionsRepository';
...
export function testQuestionsModule(currentTime: Date): TestModuleCore {
  ...
  return testModuleCore((commandBus, eventBus, queryBus) =>
    QuestionsModuleCore(eventBus, () => currentTime, questionsRepository),
  );
}
